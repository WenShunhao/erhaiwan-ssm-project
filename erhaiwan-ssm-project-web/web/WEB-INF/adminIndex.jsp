    ...
    <ul class="layui-nav layui-nav-tree layui-nav-side "  lay-filter="test" style="margin-right: 10px;">
        ...
        <li class="layui-nav-item ">
            ...
            <dl class="layui-nav-child">
                <dd><a href="javascript:;">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-search" style="font-size: 22px; color: white;"></i>详细信息查询</a></dd>
                <dd><a href="javascript:;">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-add-1" style="font-size: 22px; color: white;"></i>添加会员</a></dd>
                <dd><a href="javascript:;">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-edit" style="font-size: 22px; color: white;"></i>修改信息记录</a></dd>
                <dd><a href="javascript:;">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-delete" style="font-size: 22px; color: white;"></i>删除记录与备份</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item ">
            ...
            <dl class="layui-nav-child">
                ...
                <dd><a href="javascript:;">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-edit" style="font-size: 22px; color: white;"></i>修改信息记录</a></dd>
                <dd><a href="/backui" target="iframe_a">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-delete" style="font-size: 22px; color: white;"></i>离职员工信息</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item ">
            <a href="javascript:;"><i class="layui-icon layui-icon-release" style="font-size: 25px; color: white;"></i>停车场管理中心</a>
            <dl class="layui-nav-child">
                <dd><a href="javascript:;">&nbsp;&nbsp;&nbsp;<i class="layui-icon layui-icon-search" style="font-size: 22px; color: white;"></i>查看停车情况</a></dd>
        ...
        <li class="layui-nav-item"><a href="/recharge" target="iframe_a"><i class="layui-icon layui-icon-rmb" style="font-size: 25px; color: white;"></i>充值与收费标准</a></li>
