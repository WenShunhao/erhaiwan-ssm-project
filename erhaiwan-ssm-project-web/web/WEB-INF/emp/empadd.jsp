...
<%--        <!--手机号-->--%>
    ...
    <div class="layui-input-block kuangdaxiao" >
            <input type="text" name="ePhone" id="ePhone" required lay-verify="required|phone" placeholder="请填入11位手机号" autocomplete="off" class="layui-input">
        </div>
...
<%--身份证--%>
    ...
    <div class="layui-input-block kuangdaxiao">
            <input type="text" name="eIdcard" id="eIdcard" required lay-verify="required" placeholder="请填入你的身份证号码" autocomplete="off" class="layui-input">
        </div>
    <br>
<%--工资--%>
